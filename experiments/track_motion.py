...
class Target:
	...
	def run(self):
		...
		opencv_base_dir = '/usr/local/opt/opencv/share/OpenCV/'
		#haar_cascade = cv.Load( opencv_base_dir + 'haarcascades/haarcascade_frontalface_default.xml' )
		haar_cascade = cv.Load( opencv_base_dir + 'haarcascades/haarcascade_frontalface_alt.xml' )
		#haar_cascade = cv.Load( opencv_base_dir + 'haarcascades/haarcascade_frontalface_alt2.xml' )
		#haar_cascade = cv.Load( opencv_base_dir + 'haarcascades/haarcascade_mcs_mouth.xml' )
		#haar_cascade = cv.Load( opencv_base_dir + 'haarcascades/haarcascade_eye.xml' )
		#haar_cascade = cv.Load( opencv_base_dir + 'haarcascades/haarcascade_frontalface_alt_tree.xml' )
		#haar_cascade = cv.Load( opencv_base_dir + 'haarcascades/haarcascade_upperbody.xml' )
		#haar_cascade = cv.Load( opencv_base_dir + 'haarcascades/haarcascade_profileface.xml' )
		...
		while True:
			...
			if len(points):
				...
				codebook, distortion = vq.kmeans( numpy.asarray(points, dtype=numpy.float32), k_or_guess )
